...
async function main() {
  ...
  const products = [
    // --- Audio ---
    {
      ...
      description:
        'Spatial audio headphones with active noise cancellation and 40-hour lossless playback.',
      priceCents: 1299900,
    ...
    },
    {
      ...
      description:
        'True wireless in-ear monitors with adaptive active noise cancellation and wireless charging case.',
      priceCents: 699900,
    ...
    },
    {
      ...
      description:
        'Handcrafted natural walnut wireless desktop soundbar featuring dual passive radiators and aptX HD audio.',
      priceCents: 1049900,
    ...
    // --- Workspace ---
    {
      ...
      description:
        'Custom hot-swappable mechanical keyboard with CNC aluminum frame, lubricated switches, and gasket mount.',
      priceCents: 899900,
    ...
    },
    {
      ...
      description:
        'Contoured ergonomic wireless mouse with silent magnetic scroll wheel and dual-device Bluetooth connectivity.',
      priceCents: 349900,
    ...
    },
    {
      ...
      description:
        'Premium 4mm non-slip felt desk organizer mat crafted from natural anti-fray Australian wool fibers.',
      priceCents: 219900,
    ...
    // --- Home ---
    {
      ...
      description:
        'Adjustable dual-axis LED task lamp with warm-to-cool circadian dimming and USB-C pass-through.',
      priceCents: 499900,
    ...
    },
    {
      ...
      description:
        'Artisan-thrown matte ceramic bedside carafe set with nesting tumbler and lead-free natural glaze.',
      priceCents: 189900,
    ...
    },
    {
      ...
      description:
        'Minimalist porcelain ultrasonic aroma diffuser with ambient halo glow and 8-hour continuous misting.',
      priceCents: 379900,
    ...
    // --- Travel ---
    {
      ...
      description:
        'Weatherproof Cordura 20L backpack featuring magnetic Fidlock buckles and dedicated laptop bay.',
      priceCents: 749900,
      compareAtPriceCents: 899900,
      category: 'Travel',
      brand: 'Nomad Gear',
    ...
    },
    {
      ...
      description:
        'Structured ballistic nylon cable and accessory organizer with elastic loop grid and water-resistant YKK zippers.',
      priceCents: 249900,
    ...
    },
    {
      ...
      description:
        'Double-wall 18/8 stainless steel thermal flask with leakproof magnetic cap keeping beverages cold for 24h.',
      priceCents: 169900,
