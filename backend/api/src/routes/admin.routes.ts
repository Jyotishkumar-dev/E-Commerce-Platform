...
router.patch(
  ...
  validateBody(toggleCouponActiveSchema),
  AdminController.toggleCouponActive,
);
...
router.get(
  ...
  AdminController.getProductImages,
);
router.post(
  '/products/:productId/images',
